...
# --- Hypothèses par défaut pour la gestion de stock (ajustables par variable d'environnement) ---
# Coût de commande unitaire par défaut (S)
DEFAULT_ORDERING_COST = float(os.environ.get("OMISTOCK_DEFAULT_ORDERING_COST", "50.0"))
# Taux de possession annuel par défaut (H_rate)
HOLDING_COST_RATE = float(os.environ.get("OMISTOCK_HOLDING_COST_RATE", "0.20"))
